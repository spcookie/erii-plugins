...
enum class PersonaType(
    ...
    GOOSE_ROBOT(
        weight = 0.00, grade = PersonaGrade.EVOLUTION, personaEvolution = PersonaEvolution(
            weight = 0.3,
            type = PersonaEvolutionType.GOOSE
        )
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    LITTLE_CHICK(
        weight = 0.9, personaEvolution = PersonaEvolution(
            weight = 0.3,
            type = PersonaEvolutionType.LITTLE_CHICK
        )
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    LITTLE_CHICK_SUNGLASSES(
        weight = 0.4, personaEvolution = PersonaEvolution(
            weight = 0.4,
            type = PersonaEvolutionType.LITTLE_CHICK
        )
    ) {
    ...
    LITTLE_CHICK_KOTLIN(
        weight = 0.01, personaEvolution = PersonaEvolution(
            weight = 0.01,
            type = PersonaEvolutionType.LITTLE_CHICK
        )
    ) {
    ...
    LITTLE_CHICK_EGG_ON_HAT(
        weight = 0.0, grade = PersonaGrade.EVOLUTION, personaEvolution = PersonaEvolution(
            weight = 0.2,
            type = PersonaEvolutionType.LITTLE_CHICK
        )
    ) {
    ...
    PIG_ROBOT(
        ...
        personaEvolution = PersonaEvolution(0.3, PersonaEvolutionType.PIG)
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    PIG_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    SLIME_ANGEL(
        0.0, grade = PersonaGrade.EVOLUTION, personaEvolution = PersonaEvolution(
            type = PersonaEvolutionType.SLIME,
            weight = 0.1
        )
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    FLAMINGO_WHITE(
        weight = 0.0, grade = PersonaGrade.EVOLUTION, personaEvolution = PersonaEvolution(
            weight = 0.1,
            type = PersonaEvolutionType.FLAMINGO
        )
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    CHEESE_CAT_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    WHITE_CAT_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    CAT_WINDOW(
        0.00, grade = PersonaGrade.EVOLUTION, personaEvolution = PersonaEvolution(
            type = PersonaEvolutionType.CAT,
            weight = 0.4
        )
    ) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    RABBIT_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    DESSERT_FOX_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    GHOST_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    HAMSTER_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    MALTESE_COLLABORATOR(0.001, grade = PersonaGrade.COLLABORATOR) {
        override fun loadSvg(name: String, animationId: Long, level: Long, mode: Mode): String {
    ...
    companion object {
        ...
        private val personasForContribution by lazy {
            val weightedPersonas = mutableListOf<PersonaType>()
            entries.filterNot { it.grade == PersonaGrade.COLLABORATOR }.forEach { personaType ->
                repeat((personaType.weight * 1000).toInt()) {
                    weightedPersonas.add(personaType)
                }
            }
        ...
        fun randomForContribution(): PersonaType {
            val pool = personasForContribution
